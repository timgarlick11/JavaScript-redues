...
//Now change the food key in your favoriteThings object to be 'Lettuce' and change the book key in your favoriteThings object to be '50 Shades of Gray'.
 ...
 favoriteThings.book = 'the green mile';
...
//Now, loop through your object and alert every value. *Tyler --> 24 --> 6'0 --> Male, etc etc
 ...
 for (properties in me) {

  alert(properties  + ": " + me[properties]);
...
//Now, loop through your states object and if the states population is greater than 30K, alert that state.
 ...
 for (nums in states) {
  ...
  if(states[nums] < 30000) {
    alert(nums + ': ' + states[nums])
  }
...
object. One called 'alertHello' which alerts 'hello' and another method called logHello
 ...
 methodCollection.logHello = function(str1) {
...
var deleteUser = function(accountEmail) {
 for (var i = 0; i < users.length; i++) {
   if (users[i].email === accountEmail) {
    delete users[i]
   }
 };
 console.log(users)
